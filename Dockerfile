...
# run the server
ENTRYPOINT ["mono", "--server", "--gc=sgen", "-O=all", "TerrariaServer.exe", "-confgpath", "/config", "-worldpath", "/world", "-logpath", "/logs", "-port", "7777", "-maxplayers", "8", "-world", "/world/server.wld", "-config", "server.cfg"]
